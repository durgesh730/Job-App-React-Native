...
import { View, Text, Image, SafeAreaView, ScrollView, TouchableOpacity, Button } from 'react-native'
                    ...
                    return (
                        <View style={{ backgroundColor: "white" }} key={index} className="px-4 py-4 my-2" >
                            <View className=" py-4 flex-row justify-between items-center" >
                                <View>
                                    <Text style={{ fontSize: hp(2.6), fontFamily: "Poppins" }}>{item.Job} </Text>
                                    <Text style={{ fontSize: hp(1.8), color: "#919391", fontFamily: "Poppins" }}>{item.company} </Text>
                                </View>
                                <Image
                            ...
                            <View className="py-1 flex-row justify-start items-center gap-1" >
                                ...
                                <Text style={{ fontSize: hp(1.7), fontFamily: "Poppins" }} className='text-neutral-600' >{item.type}</Text>
                            </View>
                            ...
                            <View className="py-2 flex-row justify-start items-center gap-2" >
                                <View className="flex-row justify-start items-center" >
                                    ...
                                    <Text style={{ fontSize: hp(1.7), fontFamily: "Poppins" }} className='text-neutral-600 px-1'>{item.joining}</Text>
                                </View>

                                <View className="flex-row justify-start items-center gap-2 " >
                                    <CalendarIcon size={hp(2.3)} strokeWidth={1.5} color="#919391" />
                                    <Text style={{ fontSize: hp(1.7), fontFamily: "Poppins" }} className='text-neutral-600'>{item.duration}</Text>
                                </View>
                            </View>

                            <View className="py-2 flex-row justify-start items-center gap-2 " >
                                <CurrencyRupeeIcon size={hp(2.3)} strokeWidth={1.5} color="#919391" />
                                <Text style={{ fontSize: hp(1.7), fontFamily: "Poppins" }} className='text-neutral-600' >₹ {item.stipend}</Text>
                            </View>

                            <View className="py-2 flex-row justify-start items-center gap-2" >
                                <ClockIcon size={hp(2.3)} strokeWidth={1.5} color="#1F41BB" />
                                <Text style={{ fontSize: hp(1.7), fontFamily: "Poppins", color: "#1F41BB" }} >{item.postedDate}</Text>
                            </View>
                            ...
                            <View style={{ flexDirection: 'row', justifyContent: "flex-end", gap: 15, alignItems: 'center', paddingVertical: 8 }}>
                                ...
                                >
                                    <Text style={{ color: 'black', fontFamily: "Poppins" }}>View details</Text>
                                </TouchableOpacity>
                                ...
                                <TouchableOpacity
                                    ...
                                    onPress={() => {/* handle press */ }}
                                >
                                    <Text style={{ color: 'white', fontFamily: "Poppins" }}>Apply now</Text>
                                </TouchableOpacity>
                            </View>
